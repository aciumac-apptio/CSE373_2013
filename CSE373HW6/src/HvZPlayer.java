...
public class HvZPlayer implements Comparable<HvZPlayer> {
    ...
    public boolean equals(Object o) {
        ...
        return o instanceof HvZPlayer && name.equals(((HvZPlayer) o).name) &&
                human == ((HvZPlayer) o).human && kills == ((HvZPlayer) o).kills;
    }
    ...
    public int hashCode() {
        ...
        return kills + name.hashCode() + Boolean.valueOf(human).hashCode();
    }

    public int compareTo(HvZPlayer o) {

        if(!name.equals(o)) {
            return name.compareTo(o.name);
        } else if (human != o.human) {
            // reverse order
            // if o is zombie and player is human returns negative
            // (player is before zombie)
            return Boolean.valueOf(o.human).compareTo(this.human);
        } else {

            //return Integer.valueOf(kills).compareTo(o.kills);
            if (kills > o.kills) {
                return -1;
